main : main.cpp Aquarium.o Bestiole.o Milieu.o Capteur.o Yeux.o Oreilles.o Camouflage.o Carapace.o Nageoire.o BestioleFactory.o
	g++ -Wall -std=c++11 -o main main.cpp Aquarium.o Bestiole.o Milieu.o Capteur.o Yeux.o Oreilles.o Camouflage.o Carapace.o Nageoire.o BestioleFactory.o -I . -lX11 -lpthread
